...
name: meta_parse
date: 8 aug 2015
Adapted date: March 2017
Orig authors: Evan Gall, Erick Daniszewski
Adapted by: Nick Reynolds
description:
...
def beam_info_parse(input_file, output_file):
    """
    Parses information from the input file then formats it so it is gnuplot readable and
    writes the formatted data to a file.
    :param input_file: file name of the file to parse
...
if __name__ == "__main__":
    ...
    description = 'parser to format data into a gnuplot-readable form. meta_parse extracts the meta-information ' \
                  ...
                  'source, Fstart, fstop, spacing, bw, fbw, nfreq, nsam, npoint, integ, sigma, bsw'
    ...
    beam_info_parse(args.input_file, args.output)